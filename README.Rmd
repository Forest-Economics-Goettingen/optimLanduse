...
Both figures show the composition of the optimized farm (based on the example data), including all indicators. Each land-cover option is shown in an allocated share (%). We can now see 
