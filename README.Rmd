...
<li>
<a href="#3. Input und Output">Detailed description of the in- and output and the package elements</a>
</li>
<li>
...
The data is taken from the openly available *Supplemental material 1* of Gosling et al. (2020). It is firmly integrated into the package and can be accessed via *exampleData("exampleGosling.xlsx")*. The data is already prepared in the expected *optimLanduse* format. Gosling et al. ...
