...
forest decreases slightly from 41.2% to 34.3%, silvopasture from 45.9%
to 44.9%. The share of crops decreases from 12.9% to 1%. At the same
time, the shares of pasture increased from 0% to 9.6% and of plantation
from 0% to 10.2%.
...
contribution. This overall negative contribution appears for all
uncertainty levels. Similar appears for plantation. It is not part of
the portfolio till an uncertainty level of 1.5. It only provides best to
the long-term income, while providing by far worst to the general
preferences and also providing generally only minor contributions to the
indicators. With increasing uncertainty level
